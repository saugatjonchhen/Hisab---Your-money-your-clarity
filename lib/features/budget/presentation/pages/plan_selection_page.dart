...
class PlanSelectionPage extends ConsumerWidget {
  ...
  Widget _buildPlanCard(BuildContext context, BudgetPlan plan,
      String currencySymbol, WidgetRef ref) {
    return Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: plan.allocations.entries
                    .take(3)
                    .map((e) => Padding(
              ...
              if (plan.allocations.length > 3)
                Padding(
                  ...
                  child: Center(
                      child: Text(
                          '+ ${plan.allocations.length - 3} more categories',
                          style: const TextStyle(
  ...
  void _showPlanDetails(BuildContext context, BudgetPlan plan,
      String currencySymbol, WidgetRef ref) {
              ...
              children: [
                ListView(
                  ...
                  padding: const EdgeInsets.fromLTRB(
                      24, 24, 24, 100), // Bottom padding for button
                  children: [
                    Center(
                        child: Container(
                            width: 40,
                ...
                Positioned(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Text('Apply This Budget',
                        style: TextStyle(
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(
                  child: Text('Plan "${plan.name}" applied successfully!')),
            ],
          ),
